              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Выберите цвет для своего магазина'),
                      Box(h: 10),
                      ColorPicker(
                  ...
                  Padd(ver: 10, child: MarketThemePreview(backgroundColor: selectedColor)),
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              if (coverImage == null) {
                CustomSnackBar.showYellowSnackBar(context: context, title: "Аватар не выбрано");
                return;
              }
              var provinces =
                  context.read<ProvinceSelectingCubit>().selectedMap[ProvinceSelectingCubit
                      .product_creating_province] ??
                  [];
              if (provinces.isEmpty) {
                CustomSnackBar.showYellowSnackBar(context: context, title: "Провинция не выбрана");
                return;
              }
              if (descriptionENController.text.isEmpty ||
                  descriptionRuController.text.isEmpty ||
                  descriptionTMController.text.isEmpty) {
                CustomSnackBar.showYellowSnackBar(context: context, title: "Заполните описание");
                return;
              }
              ...
              if (addressENController.text.isEmpty ||
                ...
                CustomSnackBar.showYellowSnackBar(context: context, title: "Заполните адрес");
                return;
              }
