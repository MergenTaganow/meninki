          ...
          if (reel.product?.id != null)
            singleLine(
              ...
              onTap: () {
                ...
                Go.to(Routes.productDetailPage, argument: {"productId": reel.product!.id});
                print('object');
              },
            ),
          singleLine(context: context, title: "Поделиться", value: Svvg.asset("share")),
          singleLine(context: context, title: "Пожаловаться", value: Svvg.asset("danger_light")),
        ],
      ),
    );
  }
