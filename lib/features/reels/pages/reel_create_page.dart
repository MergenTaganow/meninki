  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context)!.newProductReview,
                                ...
                                Expanded(
                                  child: Text(
                                    uploadingFromMarket == null
                                        ? AppLocalizations.of(context)!.fromYourAccount
                                        : uploadingFromMarket!.name,
                                    style: TextStyle(fontWeight: FontWeight.w500),
                                  ),
                                ),
                                Box(w: 10),
            ...
            slivers: [
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!.productReview,
                      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
                    ),
                    SizedBox(height: 6),
                    Text(AppLocalizations.of(context)!.selectPublicationType),
                    SizedBox(height: 20),
                  ],
                ),
              ),
                  ...
                  state is ReelCreateLoading
                      ...
                      : () {
                        ...
                        if (file != null) {
                          ...
                          CustomSnackBar.showSnackBar(
                            context: context,
                            title: AppLocalizations.of(context)!.reelWillBeCreated,
                            isError: false,
                          );
