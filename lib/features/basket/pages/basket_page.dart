    ...
    return BlocListener<MyBasketCubit, MyBasketState>(
      listener: (context, state) {
        if (state is ProductAdded) {
          CustomSnackBar.showSnackBar(context: context, title: "Товар обнавлен");
        }
        if (state is ProductRemoved) {
          CustomSnackBar.showSnackBar(context: context, title: "Товар удален");
        }
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Box(h: 20),
                    Text("Добавьте еще товаров", style: TextStyle(fontSize: 16)),
                  ],
                ),
              );
            }
                  ...
                  Material(
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Мои заказы', style: TextStyle(fontWeight: FontWeight.w500)),
                            Spacer(),
      ...
      builder: (context) {
        return Padd(
          ...
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              Text("Удалить?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
              Box(h: 6),
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Да', style: TextStyle(fontWeight: FontWeight.w500)),
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Нет', style: TextStyle(fontWeight: FontWeight.w500)),
                        Svvg.asset('save'),
                      ],
                    ),
                  ),
