...
import '../widgets/public_user_reels_list.dart';
        ...
        child: BlocConsumer<GetProfileCubit, GetProfileState>(
          listener: (BuildContext context, GetProfileState state) {
            if (state is GetProfileSuccess) {
              context.read<GetUsersReelsBloc>().add(GetReel(Query(user_id: state.profile.id)));
            }
          },
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  CupertinoSliverRefreshControl(
                    onRefresh: () async {
                      context.read<GetUsersReelsBloc>().add(GetReel(Query(user_id: profile.id)));
                      await context.read<GetProfileCubit>().refreshPublicProfile(profile.id);
                    },
                  ),
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Padd(
                        ...
                        child: Column(
                          children: [
                              ...
                              Padd(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: (profile.markets?.length ?? 0),
                            ...
                            PublicUsersReelsList(userId: profile.id),
                            const Box(h: 90),
                          ],
                        ),
                      ),
