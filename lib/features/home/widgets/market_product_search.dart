...
class MarketProductsSearch extends StatelessWidget {
  ...
  const MarketProductsSearch(this.fetch, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: BlocBuilder<GetStoreProductsSearch, GetStoreProductsState>(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      margin: EdgeInsets.only(bottom: index == storesProducts.length - 1 ? 150 : 0),
